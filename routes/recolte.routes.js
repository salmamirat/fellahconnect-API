...
router.post("/", authenticate, authorize("admin", "farmer"), recolteController.createRecolte);

router.get("/", authenticate, recolteController.getAllRecoltes);

router.get("/:id", authenticate, recolteController.getRecolteById);

router.put("/:id", authenticate, authorize("admin", "farmer"), recolteController.updateRecolte);
